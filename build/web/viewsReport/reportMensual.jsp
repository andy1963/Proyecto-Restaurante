    ...
    <body class="with-side-menu">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <form class="form" action="reportSemanal.jsp" method="POST">
                
                
                <div class="modal-footer">
                    <input type="month" name="txtmonth" id="txtmonth" class="form-control" >
                    <br>
        ...
        <%  
            if (request.getParameter("btnReporte")!= null) {
                    ...
                    con.conectar();
                    File reportFile = new File(application.getRealPath("reportes/reporteBySemanal.jasper"));
                    Map parametros = new HashMap();
                    String date = request.getParameter("txtmonth");
                    parametros.put("FechaS", date);
